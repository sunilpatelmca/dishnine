...
class Category(models.Model):
    ...
    sph_permission_flags = { 'sphboard_editallposts':
                             ...
                             'sphboard_sticky':
                             'Allow marking queries as sticky.',

                             'sphboard_lock':
                             'Allow locking of queries.',

                             'sphboard_post_threads':
                             'Allow creating new queries.',

                             'sphboard_post_replies':
                             'Allow posting of replies to existing queries.',

                             'sphboard_view':
                             'Allows viewing of queries.',
                             }
    ...
    def get_absolute_url_rss_latest_threads(self):
        """ Returns the absolute url to the RSS feed displaying the latest queries.
...
class ExtendedCategoryConfig(models.Model):
    ...
    above_thread_list_block = models.TextField(blank = True, help_text = 'HTML which will be displayed above the query list.')
