...
from sphene.community.signals import profile_edit_init_form, mainsite_edit_init_form, profile_edit_save_form, mainsite_edit_save_form, profile_display
...
def accounts_forgot(request, group = None, forgot_template_name = 'sphene/community/accounts/forgot.html', forgot_sent_template_name =  'sphene/community/accounts/forgot_sent.html'):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render_to_response( forgot_sent_template_name,
                                       { },
                                       context_instance = RequestContext(request) )
    else:
        form = ForgotUsernamePassword()
    return render_to_response( forgot_template_name,
                               { 'form': form,
                                 },
                               context_instance = RequestContext(request) )
...
def register_hash(request, emailHash, group = None, register_hash_template_name = 'sphene/community/register_hash.html', register_hash_success_template_name = 'sphene/community/register_hash_success.html'):
    ...
    return render_to_response( register_hash_template_name,
                               { 'form': form },
                               context_instance = RequestContext(request) )
...
def profile_edit_mine(request, group, profile_edit_template_name = 'sphene/community/profile_edit.html',frm = None):
    return profile_edit(request, group = group, profile_edit_template_name = profile_edit_template_name,frm = frm, user_id = None)
